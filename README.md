...
Live Dashboard - dashboard.jpg Interfaccia con aggiornamento automatico dei dati live.

Analisi Storica (Analytics) - grafico.jpg Grafico a barre dinamico con i trend degli ultimi 20 inserimenti.

Backend Workflow (n8n) - n8n.jpg Il flusso logico: Webhook → Supabase (Create Row) → Response.

Database Structure (Supabase) - supabase.jpg Log dei dati salvati correttamente nella tabella greenhouse_stats.
